 ...
 * @param { UniShowToastOptions } options uni.showToast 配置项
 */
declare function validate(formData: Record<string, unknown>, rules: Record<string, Rule>, options?: UniShowToastOptions): void;


export default validate;
export type { RuleItem, UniShowToastOptions };