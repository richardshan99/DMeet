define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'cert/education/index',
                    audit_url: 'cert/education/audit',
                    table: 'cert_education'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'school', title: __('毕业学校'),operate:false},
                        {field: 'degree', title: __('学位'),operate:false},
                            ...
                            buttons:[
                                {
                                    ...
                                    url: "cert/education/audit/type/approve",
                                },
                                {
                                    name: 'audit',
                                    title: __("驳回"),
                                    ...
                                    url: "cert/education/audit/type/reject",
                                },
                            ],
